...
ALLOWED_HOSTS = ['video.wangcl,xyz', 'localhost', '127.0.0.1']
...
SITE_URL = 'http://video.wangcl.xyz/'

ROOT_URLCONF = 'video-web.urls'
...
WSGI_APPLICATION = 'video-web.wsgi.application'
